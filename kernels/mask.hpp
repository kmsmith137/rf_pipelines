...
// -------------------------------------------------------------------------------------------------
//
// _kernel_mask1<T,S,R,N> (T *weights, simd_t<int,S> mask, int stride)
//
...
inline void _kernel_mask1(T *weights, simd_t<int,S> mask, int stride)
{
    return;
}
...
// -------------------------------------------------------------------------------------------------
//
// _kernel_mask2<T,S,R,D,N> (T *weights, simd_ntuple<int,S,D> &mask, int stride)
//
...
inline void _kernel_mask2(T *weights, const simd_ntuple<int,S,D> &mask, int stride)
{
    return;
}
...
// -------------------------------------------------------------------------------------------------
//
// _kernel_mask<T,S,R,D> (T *weights, simd_t<int,S> mask, int stride)
//
...
inline void _kernel_mask(T *weights, simd_t<int,S> mask, int stride)
{
