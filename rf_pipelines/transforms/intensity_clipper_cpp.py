...
def intensity_clipper_cpp(axis=None, Df=1, Dt=1, nt_chunk=1024, sigma=3, niter=1, iter_sigma=3):
    ...
    Constructor syntax:
      ...
      t = intensity_clipper_cpp(axis=None, Df=1, Dt=1, nt_chunk=1024, sigma=3, niter=1, iter_sigma=3)
