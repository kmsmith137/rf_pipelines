...
{
    string doc_bb = ("bb_dedisperser(dm_start, dm_end, dm_tol, dm_t0, scrunch, sc_tol, sc_t0, nt_in, verbosity=1)");

    std::function<shared_ptr<pipeline_object>(double, double, double, double, bool, double, double, ssize_t, int)>
	f_bb = [](double dm_start, double dm_end, double dm_tol, double dm_t0, bool scrunch, double sc_tol, double sc_t0, ssize_t nt_in, int verbosity) -> shared_ptr<pipeline_object>
	{
	    ...
	    ini_params.scrunch = scrunch;
	    ini_params.sc_tol = sc_tol;
	    ini_params.sc_t0 = sc_t0;
    ...
    m.add_function("bb_dedisperser", doc_bb, wrap_func(f_bb, "dm_start", "dm_end", "dm_tol", "dm_t0", "scrunch", "sc_tol", "sc_t0", "nt_in", kwarg("verbosity",1)));
}
