...
transform_chain = [ rf_pipelines.plotter_transform('raw', img_nfreq=512, img_nt=1200, downsample_nt=16),
                    ...
                    rf_pipelines.intensity_clipper(thr=3, n_internal=12, axis=None, nt_chunk=clip_nt, dsample_nfreq=512, dsample_nt=clip_nt/16, test=False),
                    rf_pipelines.intensity_clipper(thr=3, n_internal=1, axis=0, nt_chunk=clip_nt, dsample_nfreq=1024, dsample_nt=clip_nt, test=False),
                    rf_pipelines.intensity_clipper(thr=3, n_internal=1, axis=1, nt_chunk=clip_nt, dsample_nfreq=1024, dsample_nt=clip_nt, test=False),
                    rf_pipelines.std_dev_clipper(thr=3, axis=1, dsample_nt=clip_nt/16),
