...
extern std::shared_ptr<wi_transform> make_online_mask_filler(int v1_chunk, float var_weight, float w_clamp, float w_cutoff, int nt_chunk, bool modify_weights, bool multiply_intensity_by_weights);
extern std::shared_ptr<wi_transform> make_scalar_mask_filler(int v1_chunk, float var_weight, float w_clamp, float w_cutoff, int nt_chunk, bool modify_weights, bool multiply_intensity_by_weights);
